...
import com.awesome.qrcode.camera.CameraManager;
import com.awesome.qrcode.camera.FrontLightMode;
import com.awesome.qrcode.util.LogUtils;
    ...
    public void onCreate(){
        ...
        onCaptureListener = new OnCaptureListener() {
            ...
            public void onHandleDecode(Result result, Bitmap barcode, float scaleFactor) {
                ...
                CaptureHelper.this.onResult(result, barcode, scaleFactor);
            }
        };
        //设置是否播放音效和震动
