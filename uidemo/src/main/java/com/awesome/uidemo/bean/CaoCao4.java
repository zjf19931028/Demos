...
public class CaoCao4 extends KlotskiBean {
    ...
    public CaoCao4(Context context) {
        ...
        super.bitmap = Bitmap.createBitmap(compressBitmap, compressBitmap.getWidth() / 2, compressBitmap.getHeight() / 2, compressBitmap.getWidth() / 2, compressBitmap.getHeight() / 2);
    }
}
